...
public class AddCompactDiscToStoreScreen extends AddItemToStoreScreen {
    ...
    // Khai báo các trường nhập liệu (Không khởi tạo tại đây để tránh NPE, sẽ khởi tạo trong createInputForm)
    ...
    protected JPanel createInputForm() {
        // Khởi tạo các trường nhập liệu cục bộ ngay trước khi sử dụng
        ...
        // Đảm bảo GridLayout là (7, 2) cho 6 cặp input + 1 cặp button
